...
public class Gun : MonoBehaviour {
    ...
    private void Awake() {
        ...
        trajectoryLine.enabled = true; // 항상 켜둠
    }
    ...
    {
        CameraShaker.instance.Shake(100f, 100f);
    }
    }
    ...
    private void Update() {
    // 총구 앞쪽으로 예측선 그리기
    trajectoryLine.SetPosition(0, fireTransform.position);
    trajectoryLine.SetPosition(1, fireTransform.position + fireTransform.forward * 10f); // 10미터 앞까지
}
}
